-- ============================================================
--  vitalife_join — Base de datos de la aplicación JOIN (versión remota)
--  Versión : 1.0.0
...
DROP TRIGGER IF EXISTS `trg_request_accepted`$$
DROP TRIGGER IF EXISTS `trg_activity_created`$$
DROP TRIGGER IF EXISTS `trg_photo_liked`$$
DROP TRIGGER IF EXISTS `trg_photo_unliked`$$
DROP TRIGGER IF EXISTS `trg_badge_awarded`$$
